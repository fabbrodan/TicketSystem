    ...
    public class IndexController : ControllerBase
    {
        ...
        public async void Index()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_dbOptions.Value.ConnectionString))
            {
                try
                {
                    string sql = @"SELECT c.ConcertId, c.CalendarDate as ConcertDate, c.Cancelled, c.Price as ConcertPrice, c.TicketsLeft, a.ArtistName, v.VenueName, v.Capacity as VenueCapacity, v.Coordinates, v.City
                                FROM Concerts c
